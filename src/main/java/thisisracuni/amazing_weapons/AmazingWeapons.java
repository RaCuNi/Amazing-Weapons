...
public class AmazingWeapons implements ModInitializer {
	...
	public static final ToolItem BLOODY_BLADE = new SwordItem(CustomToolMaterial.BLOOD, 8, -2.0f, new Item.Settings().group(MOD_GROUP));
	public static final ToolItem DAGGER_SACRIFICE = new DaggerSacrifice(CustomToolMaterial.BLOOD, 3, 0.4f, new Item.Settings().group(MOD_GROUP));

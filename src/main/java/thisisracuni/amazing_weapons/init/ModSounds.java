...
public class ModSounds {
    ...
    public static final Identifier DAGGER_ATTACK_SOUND_ID = new Identifier("amazing_weapons:dagger_attack");
    public static final SoundEvent DAGGER_ATTACK_SOUND_EVENT = new SoundEvent(DAGGER_ATTACK_SOUND_ID);
    
    public static void init() {
        Registry.register(Registry.SOUND_EVENT, DAGGER_USE_SOUND_ID, DAGGER_USE_SOUND_EVENT);
        Registry.register(Registry.SOUND_EVENT, DAGGER_ATTACK_SOUND_ID, DAGGER_ATTACK_SOUND_EVENT);
    }
